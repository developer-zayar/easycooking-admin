...
@section('content')
    <div class="container py-5">
        ...
        <p>This Privacy Policy explains how we handle your information.</p>
    </div>
@endsection
...
<body>
    ...
    <p>This privacy policy applies to the EasyCookingMM app (hereby referred to as "Application") for mobile devices
        that was created by Proton App Studio (hereby referred to as "Service Provider") as a Free service. This service
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with
        certain personally identifiable information, including but not limited to Email, name, phone number. The
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
        ...
        please contact them at protonappstudio@gmail.com and they will respond in a reasonable time.</p>
    ...
    <div><br>
        <p>The Application does not address anyone under the age of 13.
            ...
            personal information, please contact the Service Provider (protonappstudio@gmail.com) so that
    ...
    <p>This privacy policy is effective as of 2025-06-01</p><br><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
        please contact the Service Provider via email at protonappstudio@gmail.com.</p>
    <hr>
